...
function catch_irc() {
    ...
    case 0: // the primary bot, responsible only for in-channel communication
        ...
        case 'JOIN':    // :#channel
            ...
            default: say("Welcome to the Pirate Party of Canada meeting channel. Please visit {$config['loginurl']} to log in, or type " . chr(2) . "/msg {$config['bots'][1]['nick']} HELP LOGIN" . chr(2) . " for help.", $data['subject'], 1, false);
            case false:
            }
